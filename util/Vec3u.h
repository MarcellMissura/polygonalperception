...
public:
    ...
    Vec3u(const VecNu<2> &o, double xo) : VecNu<3>(o, xo) {}
    Vec3u(double xo, const VecNu<2> &o) : VecNu<3>(xo, o) {}
    Vec3u(const VecNu<4> &o) : VecNu<3>(o) {}
    Vec3u(const uint* o) : VecNu<3>(o) {}
    Vec3u(double xo, double yo, double zo=0, double wo=0, double ao=0, double bo=0, double co=0) : VecNu<3>(xo, yo, zo, wo, ao, bo, co) {}
